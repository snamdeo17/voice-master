...
public interface BillRepository extends JpaRepository<Bill, Long> {
	...
	@Query("SELECT b FROM Bill b WHERE b.user.userId=:userId and MONTH(b.dueDate) = :month and b.consumerId=:consumerId")
	List<Bill> findByUserIdAndMonth(@Param("userId") Integer userId, @Param("month") Integer month, @Param("consumerId") Integer consumerId);
